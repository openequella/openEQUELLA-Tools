...
public class EQUELLASOAP
{
	 ...
	 * return result.
	 */
	public XMLWrapper searchItems(String query, String where, boolean onlyLive, int sortType,
		boolean reverseSort, int offset, int maxResults)
	{
		try
		{
			return new XMLWrapper(client.searchItems(query, null, where, onlyLive, sortType,
				reverseSort, offset, maxResults));
		}
		catch( Exception e )
		{
			throw new RuntimeException(e);
	...
	//Returns the uuid.
	public String addUser(String userId, String username, String password, String firstName, String lastName, String email)
	{
		try
		{
	...
	//Returns the uuid.
	public String editUser(String userId, String username, String password, String firstName, String lastName, String email)
	{
		try
		{
			String result = client.editUser(userId, username, password, firstName, lastName, email);
			//System.out.printf("Call result [%s].\n", result);
			return result;
		}
		catch( Exception e )
	 ...
	 * @return A token that can be directly appended to a URL (i.e. it is already URL encoded) 
	 * E.g.  URL = URL + "?token=" + URLEncoder.encode(EQUELLASOAP.generateToken(x,y,z), "UTF-8")
	 */
	public static String generateToken(String username, String sharedSecretId,
