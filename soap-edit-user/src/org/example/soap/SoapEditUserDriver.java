...
public class SoapEditUserDriver {
	private final String endpoint;
	private final String username;
	private final String password;

	public static void main(String[] args) {
		SoapEditUserDriver driver = new SoapEditUserDriver(true);
		String uuid = "....";
		String username = "....";
	...
	public SoapEditUserDriver(boolean useproxy) {
	...
	protected void execute(String uuid, String uname, String pw, String fName, String lName, String email) {
		...
		System.out.printf("Editing user uuid=[%s], username=[%s], password=[%s], first-name=[%s], last-name=[%s], email=[%s]\n", uuid, uname, pw, fName, lName, email);
		
		String result = equella.editUser(uuid, uname, pw, fName, lName, email);

		if(result.equals(uuid)) {
			System.out.printf("User edited.\n");	
		} else {
			System.out.printf("User edit attempted, but result was not the expected uuid.  Expected uuid=[%s], actual result=[%s]\n", uuid, result);	
		}
